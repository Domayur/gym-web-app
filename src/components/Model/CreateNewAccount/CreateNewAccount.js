                        ...
                        <div class="modal-body">
                            ...
                            <div className='container'>
                                <div className='row  back-col-cst'>
                                    <div className='col'>
                                        <p className='text-center inner-para-cst'><BsGoogle/> Sign up with Google</p>
                                    </div>
                                </div><br />
                                <div className='row  back-col-cst'>
                                    <div className='col  '>
                                        <p className='text-center inner-para-cst'><BsFacebook /> Sign up with Facebook</p>
                                    </div>
                                </div><br />
                                <div className='row  back-col-cst'>
                                    <div className='col'>
                                        <p className='text-center inner-para-cst' data-bs-toggle="modal" data-bs-target="#exampleModal2"><BsFillEnvelopeFill /> Sign up with Email</p>
                                    </div>
                                </div><br />
                            </div>
                        </div>
